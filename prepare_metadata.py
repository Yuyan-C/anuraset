...
df_INCT17.to_csv("/network/scratch/y/yuyan.chen/anuraset/INCT17_metadata.csv")
df_INCT20955.to_csv("/network/scratch/y/yuyan.chen/anuraset/INCT20955_metadata.csv")
